...
struct Item: Codable, Equatable, Comparable, Hashable {
    ...
    init(title: String, count: Int? = nil, SPCost: Int? = nil, CPCost: Int? = nil, SPGain: Int? = nil, CPGain: Int? = nil, incompatibility: String? = nil, requirement: String? = nil, comment: String? = nil, desc: String, image: String? = nil) {
        self.title = title
        self.count = count
        self.SPCost = SPCost
        self.CPCost = CPCost
